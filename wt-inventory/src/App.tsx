  ...
  return (
    <HashRouter>
      <Routes>
        ...
        <Route
          path="/worlds"
          element={<PlaceholderPage title="选择世界" note="单人游戏：世界列表（worlds.md）" />}
        />
        <Route
          path="/create"
          element={
            <PlaceholderPage
              title="创建新的世界"
              note="创建世界主屏 + 更多世界选项（create-world.md）"
            />
          }
        />
        <Route
          path="/multiplayer"
          element={
            <PlaceholderPage title="多人游戏" note="服务器列表 / Realms 提示（multiplayer.md）" />
          }
        />
        <Route
          path="/options"
          element={<PlaceholderPage title="选项" note="选项主屏（options.md）" />}
        />
        <Route path="/options/video" element={<PlaceholderPage title="视频设置" />} />
        <Route path="/options/sound" element={<PlaceholderPage title="音乐和声音" />} />
        <Route path="/options/controls" element={<PlaceholderPage title="按键控制" />} />
        <Route path="/options/mouse" element={<PlaceholderPage title="鼠标设置" />} />
